...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((df[df['education'].isin(advanced_edu)]['salary'] == '>50K').mean() * 100, 1)
    
    lower_education_rich = round((df[~df['education'].isin(advanced_edu)]['salary'] == '>50K').mean() * 100, 1)
